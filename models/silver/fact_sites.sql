...
agg_cte as (
    ...
    select 
        ...
        sum(previous_land_value) as previous_land_value,
        sum(previous_improvement_value) as previous_improvement_value,
        sum(previous_total_value) as previous_total_value,
